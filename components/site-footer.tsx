  ...
  return (
    <footer className="global-footer">
      ...
      <div className="footer-links">
        <div><span>Explore</span><Link href="/materials">All materials</Link><Link href="/locations">Trading locations</Link><Link href="/quality">Quality process</Link><Link href="/faq">Scrap Q&A</Link></div>
